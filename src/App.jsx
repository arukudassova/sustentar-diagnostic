...
const GLOBAL_STYLES = `
  ...
  .anim-fade-in-up { animation: fadeInUp 0.38s cubic-bezier(.22,1,.36,1) both; }
...
export default function App() {
  ...
  if (step === "intro") return (
    <div style={s.page} className="anim-fade-in">
      <GlobalStyles />
      {/* ONBOARDING OVERLAY */}
      {showOnboarding && (
  ...
  if (step === "calculating") {
    const calcMsgs = {
      es: ["Analizando respuestas…", "Calculando puntajes por dimensión…", "Generando recomendaciones…"],
      en: ["Analysing responses…", "Calculating scores by dimension…", "Generating recommendations…"],
    };
    return (
      <div style={{ ...s.page, flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 24 }} className="anim-fade-in">
        <GlobalStyles />
        <div style={s.calcSpinner} />
        <div style={s.calcText}>
          {calcMsgs[lang].map((msg, i) => (
            <div key={i} style={{ ...s.calcLine, animationDelay: `${i * 0.45}s` }} className="anim-fade-in-up">{msg}</div>
          ))}
        </div>
        <div style={s.calcCity}>{cityName}</div>
      </div>
    );
  }
  ...
  return (
    <div style={s.page} className="anim-fade-in">
      ...
      <div style={{ ...s.card, maxWidth: 680 }}>
        ...
        <div key={catIdx} className="anim-fade-in-up" style={{ marginBottom: 24 }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          ...
          {catIdx < cats.length - 1
            ...
            : <button style={{ ...s.btnPrimary, opacity: answered === totalQ ? 1 : 0.4, cursor: answered === totalQ ? "pointer" : "default" }} disabled={answered !== totalQ} onClick={goToResults}>{t.resultsBtn}</button>
          }
        </div>
      </div>
    </div>
...
const s = {
  ...
  calcSpinner: { width: 44, height: 44, border: `3px solid ${TEAL_MID}`, borderTopColor: TEAL, borderRadius: "50%", animation: "spin 0.9s linear infinite" },
  calcText: { display: "flex", flexDirection: "column", alignItems: "center", gap: 10 },
  calcLine: { color: TEXT, fontSize: 14, fontWeight: 500 },
  calcCity: { color: MUTED, fontSize: 12, marginTop: 4 },
